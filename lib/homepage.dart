...
class RecyclingHomePage extends StatelessWidget {
                  ...
                  children: [
                    Expanded(
                      child: ListView(
                        ...
                        children: [
                          wasteCategoryCard(
                              Icons.phone_iphone, 'Small E', primaryColor),
                          wasteCategoryCard(
                              Icons.tv, 'Consumer E', primaryColor),
                          wasteCategoryCard(
                              Icons.computer, 'IT & Telecom', primaryColor),
                          wasteCategoryCard(
                              Icons.battery_full, 'Batteries', primaryColor),
                          wasteCategoryCard(
                              Icons.power, 'Cables & Chargers', primaryColor),
                        ],
                      ),
                    ),
                  ],
  ...
  Widget recyclingBanner(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            'Earn Rewards for Every Recycle!',
            style: TextStyle(
              fontSize: 16.sp,
              fontWeight: FontWeight.bold,
              color: Colors.white,
          ...
          SizedBox(height: 1.h),
          Text(
            'Recycle your e-waste responsibly and earn points.',
            style: TextStyle(
              fontSize: 12.sp,
          ...
          ElevatedButton(
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => StartRecyclingPage()),
              );
            },
